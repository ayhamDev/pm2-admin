      ...
      >
        <Table.Header>
          <Table.Row>
            ...
            <Table.ColumnHeaderCell className="min-w-[150px]">
              Ip Address
            ...
            <ContextMenu.Root key={index}>
              <ContextMenu.Trigger>
                ...
                >
                  ...
                  <Table.Cell>
                    <span className="px-4 py-1 text-white s bg-slate-500 font-extrabold rounded-full">
                      Checking
                    </span>
                  </Table.Cell>
                  {/* <Table.Cell>
